...
import org.demo.service.PeopleService;
...
public class PersonController {
	...
	PeopleService svc;
	@GetMapping("/people")
	public String retrievePeople(@RequestParam(value = "firstName", required = false) String firstName,
			@RequestParam(value = "lastName", required = false) String lastName, Model model) {
		if (firstName != null || lastName != null)
			model.addAttribute("people", svc.retrievePeopleByName(firstName, lastName));
